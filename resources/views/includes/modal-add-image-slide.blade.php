            ...
            <form method="POST" action="{{ route('admin.store.slide') }}" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-5 lg:grid-cols-2 xl:grid-cols-12">
                    <div class="xl:col-span-6">
                        ...
                        <input type="file" class="border-0 bg-light pl-0" name="slide_image" id="image15" hidden>
                        <div id="btnimage">
                            <img id="showImage15" class="show-avatar" src="{{ asset('/images/layout/500x250.png') }}" alt="avatar">
                        </div>
                        <div id="button-15">
