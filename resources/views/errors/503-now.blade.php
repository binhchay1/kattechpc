...
@section('keywords', '503, kattechpc, kattech')
...
<div class="mb-0 border-none shadow-none lg:w-[500px] card bg-white/70 dark:bg-zink-500/70">
    <div class="!px-10 !py-12 card-body">
        ...
        <div class="mt-8 text-center">
            ...
            <p class="mb-6 text-slate-500 dark:text-zink-200">{{ __('Bạn không có quyền truy cập vào đường dẫn này. Nếu quý khách cần hỗ trợ, xin vui lòng liên hệ '. config('company.hotline') . ' để được tư vấn sớm nhất') }}</p>
        </div>
    </div>
