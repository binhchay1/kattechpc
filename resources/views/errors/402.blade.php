...
<div class="mb-0 border-none shadow-none lg:w-[500px] card bg-white/70 dark:bg-zink-500/70">
    <div class="!px-10 !py-12 card-body">
        ...
        <div class="mt-8 text-center">
            <h4 class="mb-2 text-purple-500">{{ __('Xin lỗi, Yêu cầu thanh toán') }}</h4>
            <p class="mb-6 text-slate-500 dark:text-zink-200">{{ __('Bạn cần thanh toán trước khi truy cập vào địa chỉ này!') }}</p>
            @if(!Auth::check())
