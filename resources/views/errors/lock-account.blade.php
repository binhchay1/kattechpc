    ...
    <div class="mb-0 border-none shadow-none lg:w-[500px] card bg-white/70 dark:bg-zink-500/70">
        <div class="!px-10 !py-12 card-body">
            ...
            <div class="mt-8 text-center">
                <h4 class="mb-2 text-purple-500">{{ __('Xin lỗi, tài khoản của bạn đang bị vô hiệu hóa') }}</h4>
                <p class="mb-6 text-slate-500 dark:text-zink-200">{{ __('Bạn không có quyền truy cập vào đường dẫn này, liên hệ với admin để biết thêm thông tin!') }}</p>
