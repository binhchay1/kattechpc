...
<div class="mb-0 border-none shadow-none lg:w-[500px] card bg-white/70 dark:bg-zink-500/70">
    <div class="!px-10 !py-12 card-body">
        ...
        <div class="mt-8 text-center">
            <h4 class="mb-2 text-purple-500">{{ __('Xin lỗi, Truy cập bị chặn') }}</h4>
            <p class="mb-6 text-slate-500 dark:text-zink-200">{{('Truy cập của bạn bị giới hạn do chỉnh sửa của chúng tôi. Liên hệ với bộ phận admin để biết thêm chi tiết!')}}</p>
            @if(!Auth::check())
