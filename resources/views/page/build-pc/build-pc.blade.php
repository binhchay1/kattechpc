            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, val) {
                        let newPrice = val.new_price;
                        let slug = val.slug;
                        let url ="{{ route('buildPC') }}" + '/' + slug ;
                        var vatrate = Math.floor(100 - (newPrice / val.price * 100));
                        console.log(vatrate)
                        $(".list-product-select").append("<div class=\"row p-item\">\n" +
                            "                        <div class=\"col-lg-3\">\n" +
                            ...
                            "                            <a href=\"\" class=\"p-name\">"+val.name+"</a>\n" +
                            "                            <table>\n" +
                            "                                <tbody>\n" +
                            "                                    <tr>\n" +
                            "                                        <td><b>Bảo hành:</b></td>\n" +
