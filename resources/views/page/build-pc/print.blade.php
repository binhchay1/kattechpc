    ...
    <div style="width: 800px;margin: 0 auto;">
            ...
            <tbody>
                <tr>
                    ...
                    <td colspan="5" align="right" style="line-height: 19px;">
                        ...
                        Xuân, TP.Hà Nội<br>
                        Cơ sở 1: Số 50 Trần Phú, P. Mộ Lao, Q.Hà Đông, Hà Nội<br>
        ...
        <table width="800" class="list_table" border="1">
            <tbody>
                ...
                <tr>
                    <td>1</td>
                    <td colspan="2">
                        <a href="https://nguyencongpc.vn/gia-do-man-hinh-gaming-e-dra-eam7301">Giá đỡ màn hình gaming E DRA - EMA7301</a> <br>
                        Mã sp:PK0000073 <br>
                    </td>
                    <td>24 tháng </td>
                    <td>1</td>
                ...
                <tr>
                    ...
                    <td style="background:#b8cce4;">590.000 đ</td>
                </tr>
        ...
        <table width="800">
            <tbody>
                ...
                <tr>
                    <td colspan="7">
                        {{ __('Để biết thêm chi tiết, Quý khách vui lòng liên hệ KATTECH PC qua hotline') }} 097.9999.191 - 0828.333.363 - 0707.08.6666 - 09.8888.2838 (8h30-18h30 {{ __('tất cả các ngày trong tuần') }}) {{ __('hoặc email') }}: <a href="mailto:info@kattechpc.vn">info@kattechpc.vn</a>
                    </td>
                </tr>
                <tr>
