                ...
                <div class="basket-product">
                    <div class="item">
                        <div class="product-image">
                            @if(isset($product->attributes->image))
                            @php
                            $product->attributes->image = json_decode($product->attributes->image, true);
                            @endphp
                            <img src="{{ asset($product->attributes->image[0]) }}" alt="Placholder Image 2" class="product-frame">
                            @endif
                        </div>
                    ...
                    <div class="price">{{ $product->new_price }} đ</div>
                    @else
