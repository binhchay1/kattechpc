            ...
            <div class="column1">
                <div class="top5 flex">
                    ...
                    <div style="float: right; width: 35%; margin-left: 10px">
                        @foreach($promotionRandom->posts as $key => $random)
                            @if($key == 0)
                                <div class="">
                                    <div class="position-relative mb-3">
                                        <img class="img-fluid w-100" alt="{{ $random->title }}" src="{{ asset($random->thumbnail ?? 'images/page/no-image.png') }}" >
                ...
                <div class=" top1">
                    <div class="">
                        @foreach($promotionCategory->posts as $random)
                            <div class="child d-flex">
                                <img class="img-fluid w-100" src="{{ asset($random->thumbnail ?? 'images/page/no-image.png') }} " style="object-fit: cover;">
                                <div class="">
