...
<div class="container">
    <div class="row d-flex post-data">
        ...
        <div class="column2" id="post-column2">
            ...
            <div class="row top2">
                <h2 class="text-title" style="background-color: #03304b; margin: 0"> {{__('TIN TỨC GẦN NHẤT')}}
                    <span style="position: absolute;">
                        <img id="img-icon-hot" src="{{ asset('/images/icon-blog.png') }}">
                    </span>
                </h2>
                <div style="background: white; padding: 10px; box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px; border-radius: 10px">
