...
@section('css')
    ...
    <link rel="stylesheet" href="{{ asset('css/page/online-shopping.css') }}"/>
@endsection
...
@section('content')
    <div class="container">
            ...
            <div class="">
                ...
                <div class="policy-step">
                    <div class="d-flex flex-column ml-10px">
                        ...
                        <span class="policy-title">{{ __('Bạn truy cập vào website để mua hàng trực tuyến. Dưới đây là các bước hướng dẫn mua hàng trực tuyến bên KATTECH.COM') }}</span>
                    </div>
                </div>
        ...
        <div class="row top">
            ...
            <img src="{{asset('/images/page/image1.png')}}">
