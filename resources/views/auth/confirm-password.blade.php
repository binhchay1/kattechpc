            ...
            <div class="!px-12 !py-12 card-body h-full flex flex-col">
                ...
                <div class="my-auto">
                    <div class="mt-8 text-center">
                        ...
                        <h4 class="mb-2 text-custom-500 dark:text-custom-500">{{__('Xác nhận tài khoản của bạn')}}</h4>
                        <p class="mb-8 text-slate-500 dark:text-zink-200">{{__('Cảm ơn bạn đã sử dụng')}}</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('password.confirm') }}">
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">{{__('Quay lại trang chủ')}} <a href="{{ route('dashboard') }}"
                                    class="underline fw-medium text-custom-500"> {{__('Chọn vào đây')}} </a> </p>
                        </div>
                    </form>
                </div>
            </div>
