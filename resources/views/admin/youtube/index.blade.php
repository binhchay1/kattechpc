        ...
        <div class="card" id="usersTable">
            <div class="card-body">
                <div class="flex items-center">
                    <h6 class="text-15 grow">{{ __('Danh sách video') }}</h6>
                    <div class="lg:col-span-2 ltr:lg:text-right rtl:lg:text-left xl:col-span-2 xl:col-start-11 button-add">
                        <a href="{{ route('admin.youtube.create') }}" type="button" class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20"><i data-lucide="plus" class="inline-block size-4"></i> <span class="align-middle">{{ __('Thêm video') }}</span></a>
                    </div>
                </div>
            </div>
                    ...
                    <table class="w-full border-separate table-custom border-spacing-y-1 whitespace-nowrap">
                        <thead class="text-left">
                            <tr class="relative rounded-md bg-slate-100 dark:bg-zink-600 after:absolute ltr:after:border-l-2 rtl:after:border-r-2 ltr:after:left-0 rtl:after:right-0 after:top-0 after:bottom-0 after:border-transparent [&.active]:after:border-custom-500 [&.active]:bg-slate-100 dark:[&.active]:bg-zink-600">
                                ...
                                <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort" data-sort="slug">{{ __('Đường dẫn') }}
                                </th>
                        ...
                        <tbody class="list">
                            @foreach($listYoutubeChannel as $index => $youtube)
                            <tr class="relative rounded-md after:absolute ltr:after:border-l-2 rtl:after:border-r-2 ltr:after:left-0 rtl:after:right-0 after:top-0 after:bottom-0 after:border-transparent [&.active]:after:border-custom-500 [&.active]:bg-slate-100 dark:[&.active]:bg-zink-600">
                                ...
                                <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">{{ $youtube->title }}
                                </td>

                                <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">{{ $youtube->link }}
                                </td>

                                <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">
                                    <img width="40" height="30" src="{{ $youtube->thumbnail }}">
                                </td>
                                ...
                                <div class="w-screen md:w-[25rem] bg-white shadow rounded-md dark:bg-zink-600">
                                    <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto px-6 py-8">
                                        ...
                                        <div class="mt-5 text-center">
                                            ...
                                            <p class="text-slate-500 dark:text-zink-200">{{ __('Bạn có muốn xóa video này không??') }}</p>
