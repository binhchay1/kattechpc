                                ...
                                <div class="">
                                    <div class="" style="display: inline-grid;">
                                        ...
                                        <div class=" choose-avatar">
                                            <div id="btnimage">
                                                <img id="showImage" class="show-avatar" src="{{ asset($post->thumbnail ?? '/images/product.png') }}" alt="avatar">
                                            </div>
                                            <div id="button">
