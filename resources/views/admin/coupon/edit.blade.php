            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{route('admin.coupon.update', $coupon['id'])}}" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 gap-5 lg:grid-cols-2 xl:grid-cols-12">
                        ...
                        <div class="xl:col-span-6" id="discount-by-number">
                            ...
                            <span style="display: flex; align-items: center;">
                                ...
                                <input type="number" id="discount_amount" name="discount_amount_number" onkeyup="onlyNumberAmount(this)" value="{{ old('discount_amount', $coupon->discount_amount) }}" class="form-input input-element border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" min="1" max="100" placeholder="{{ __('Số tiền giảm giá') }}">
                                @else
                                <input type="number" id="discount_amount" name="discount_amount_number" onkeyup="onlyNumberAmount(this)" value="{{ old('discount_amount') }}" class="form-input input-element border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="{{ __('Số tiền giảm giá') }}">
                                @endif
                    ...
                    <div class="flex justify-end gap-2 mt-4">
                        ...
                        <button type="submit" class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">{{__('Sửa mã khuyến mãi')}}</button>
                    </div>
                </form>
            </div>
        </div>
