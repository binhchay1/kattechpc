                                                ...
                                                <div class="">
                                                    <div class="" style="display: inline-grid;">
                                                        ...
                                                        <div class="area-action-layout">
                                                            <button type="button" class="btn-delete-layout" onclick="deleteThumb('messager')">{{ __('Xóa') }}</button>
                                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="">
                                                    <div class="" style="display: inline-grid;">
                                                        ...
                                                        <div class="area-action-layout">
                                                            <button type="button" class="btn-delete-layout" onclick="deleteThumb('facebook')">{{ __('Xóa') }}</button>
                                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="">
                                                    <div class="" style="display: inline-grid;">
                                                        ...
                                                        <div class="area-action-layout">
                                                            <button type="button" class="btn-delete-layout" onclick="deleteThumb('youtube')">{{ __('Xóa') }}</button>
                                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="">
                                                    <div class="" style="display: inline-grid;">
                                                        ...
                                                        <div class="area-action-layout">
                                                            <button type="button" class="btn-delete-layout" onclick="deleteThumb('zalo')">{{ __('Xóa') }}</button>
                                                        </div>
                                                        @if ($errors->has('zalo'))
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="">
                                                    <div class="" style="display: inline-grid;">
                                                        ...
                                                        <div class="area-action-layout">
                                                            <button type="button" class="btn-delete-layout" onclick="deleteThumb('instagram')">{{ __('Xóa') }}</button>
                                                        </div>
