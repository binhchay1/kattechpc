                    ...
                    <table class="w-full border-separate table-custom border-spacing-y-1 whitespace-nowrap">
                        ...
                        <tbody class="list">
                            ...
                            <tr class="relative rounded-md after:absolute ltr:after:border-l-2 rtl:after:border-r-2 ltr:after:left-0 rtl:after:right-0 after:top-0 after:bottom-0 after:border-transparent [&.active]:after:border-custom-500 [&.active]:bg-slate-100 dark:[&.active]:bg-zink-600">
                                ...
                                <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">{{ $productRating->code }}
                                </td>
                                <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">{{round($productRating->ratings->avg('rating_product'))}}
                                ...
                                <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">
                                    {{ $productRating->ratings->count() . ' lượt đánh giá' }}
                                </td>
                                ...
                                <td>
                                    <div class="relative dropdown">
                                        ...
                                        <ul class="absolute z-50 hidden py-2 mt-1 ltr:text-left rtl:text-right list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zink-600" aria-labelledby="usersAction1">
                                            <li>
                                                <a data-modal-target="deleteModal-{{ $key }}" class="block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200" href="#!"><i data-lucide="trash-2" class="inline-block size-3 ltr:mr-1 rtl:ml-1"></i> <span class="align-middle">{{ __('Xóa') }}</span></a>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
                            <div id="deleteModal-{{ $key }}" modal-center class="fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show">
                                    ...
                                    <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto px-6 py-8">
                                        ...
                                        <div class="mt-5 text-center">
                                            ...
                                            <div class="flex justify-center gap-2 mt-6">
                                                ...
                                                <a href="{{route('admin.ratting.delete', $productRating->ratings[0]->id)}}">
